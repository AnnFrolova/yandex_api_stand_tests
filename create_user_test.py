...
def test_create_user_2_letter_in_first_name_get_success_response():
    ...
    # Тест 2. Параметр fisrtName состоит из 15 символов
def test_create_user_15_letter_in_first_name_get_success_response():
        positive_assert("Aaааааааааааааа")

    # Тест 3. Негатив. Параметр fisrtName состоит из 1 символа
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть код 400 и сообщение
...
# Тест 4. Негатив. Параметр fisrtName состоит из 16 символа
...
# Тест 7. Негатив. Запрещены пробелы
def test_create_user_has_space_in_first_name_get_error_response():
        negative_assert_symbol("Человек и Ко")

# Тест 8. Негатив. Запрещены спец.символы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

# Тест 9. Негатив. Запрещены цифры
...
# Тест 10. Негатив. Параметр не передан в запросе
...
# Тест 12. Ошибка. Передан другой тип параметра ferst_name - число
